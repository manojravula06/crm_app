      ...
      <div className="container pt-5">
        ...
        {createTicketModal ? (
          ...
          >
            ...
            className="fw-bold text-danger">CREATE A NEW TICKET</Modal.Header>
            <Modal.Body>
              <form onSubmit={createTicket}>
                ...
                <div className="d-flex justify-content-center">
                  ...
                  <Button className="m-1 fw-bold" type="submit" variant="success">
                    CREATE
                  </Button>
                </div>
              </form>
        ...
        {ticketUpdationModal ? (
          ...
          >
            <Modal.Header closeButton className="fw-bold text-danger">UPDATE THE TICKET</Modal.Header>
            <Modal.Body>
              <form onSubmit={updateTicket}>
                <h5 className="card-title lead text-success fw-bold">
