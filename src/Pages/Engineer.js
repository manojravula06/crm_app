    ...
    <div className="bg-light vh-100">
      ...
      <div className="container py-5">
        ...
        <MaterialTable
          ...
          columns={columns}
          data={ticketDetails}
          title={`Tickets assaigned to ${localStorage.getItem("name")}`}
          options={{
            filtering: true,
            exportMenu: [
              {
                ...
                exportFunc: (cols, data) =>
                  ExportPdf(cols, data,`Ticket records assigned to ${localStorage.getItem("name")}`),
              },
              {
                label: "Export Csv",
                exportFunc: (cols, data) =>
                  ExportCsv(cols, data,`Ticket records assigned to ${localStorage.getItem("name")}`),
              },
            ],
            headerStyle: {
